...
val md_theme_light_primaryContainer = Color(0xFFD1E8FF)
...
// Dark Theme Colors (optional - for dark mode support)
val md_theme_dark_primary = Color(0xFF9DCBFF)
val md_theme_dark_onPrimary = Color(0xFF003258)
val md_theme_dark_primaryContainer = Color(0xFF00497D)
val md_theme_dark_onPrimaryContainer = Color(0xFFD1E8FF)
